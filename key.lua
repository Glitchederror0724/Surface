...
local Config = {
    ...
    ServiceId       = 29496, -- Your PlatoBoost Service ID
    PlatoSecret     = "1021ca24-5d32-4433-9143-d566dabd5d84", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "Owner_Of_Surface", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/Glitchederror0724/Surface/refs/heads/main/surface_explots.lua", -- The raw URL of your main script
    ...
    HubName         = "Surface", -- The main title shown at the top of the GUI
    HubDescription  = "Surface is a script used to get assect to basic cmds anywere and has a built-in script loader" -- The text shown below the title
}
